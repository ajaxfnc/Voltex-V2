...
const registerEvents = (client) => {
  for (const dir of readdirSync("/root/ghoul trooper testbot/src/events/")) {
    for (const file of readdirSync("/root/ghoul trooper testbot/src/events/" + dir).filter((f) => f.endsWith('.js'))) {
