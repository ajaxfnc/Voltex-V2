...
module.exports = (client) => {
    for (const dir of readdirSync("/root/ghoul trooper testbot/src/components/")) {
        for (const file of readdirSync("/root/ghoul trooper testbot/src/components/" + dir).filter((f) => f.endsWith('.js'))) {
